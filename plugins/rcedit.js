...
const options = {
	...
	icon: path.resolve(__dirname, "../source/FS.ico"),
};

const fetched = path.resolve(__dirname, "../.pkg-cache/v3.4/fetched-v16.16.0-win-x64");
const built = path.resolve(__dirname, "../.pkg-cache/v3.4/built-v16.16.0-win-x64");

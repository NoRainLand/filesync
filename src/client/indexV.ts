...
//         this.clipboard = new (window as any).ClipboardJS("." + HtmlControl.copyBtnClass);
//         this.clipboard.on('error', function (e: any) {
//             TipsMgr.showNotice("复制失败，可能是权限不足或者浏览器不支持");
//             console.error(e);
//         });
//     }

//     getUI() {
//         this.fileInput = document.getElementById('fileInput') as HTMLFieldSetElement;

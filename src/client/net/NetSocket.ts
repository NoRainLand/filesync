...
export class NetSocket {
    ...
    private addEvent() {
        ...
        if (this.socket) {
            ...
            this.socket.addEventListener("open", this._onSocketOpen.bind(this));
            this.socket.addEventListener("close", this._onSocketClose.bind(this));
    ...
    private removeEvent() {
        ...
        if (this.socket) {
            this.socket.removeEventListener("message", this._onSocketMessage.bind(this));
            this.socket.removeEventListener("open", this._onSocketOpen.bind(this));
            this.socket.removeEventListener("close", this._onSocketClose.bind(this));
            this.socket.removeEventListener("error", this._onSocketError.bind(this));
        }
    }
